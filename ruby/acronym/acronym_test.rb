...
class AcronymTest < Minitest::Test
  ...
  def test_german_uppercase_letter
    # skip
    assert_equal "ÄSG", Acronym.abbreviate('Änderungen sind gut', :de)
  end

  def test_german_lowercase_letter
    # skip
    assert_equal "ÄSG", Acronym.abbreviate('änderungen sind gut', :de)
  end
  ...
  def test_error
    # skip
    # assert_equal "Page", Acronym.abbreviate('P')
    assert_raises ArgumentError do
      Acronym.abbreviate('Page')
    end
  end
